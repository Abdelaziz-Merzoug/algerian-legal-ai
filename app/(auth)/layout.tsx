    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy via-navy-secondary to-navy p-4 relative overflow-hidden">
            ...
            <button
                ...
                className="absolute top-4 end-4 rtl:right-auto rtl:start-4 p-2.5 rounded-xl bg-bg-card/80 border border-border text-teal hover:bg-teal-light transition-all duration-200 z-10"
